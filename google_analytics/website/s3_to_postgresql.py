...
def handler(event, context):
    ...
    with connection.cursor() as cur:
        ...
        cur.execute("CREATE TABLE most_visited_pages_7days(date varchar(255), page varchar(255), views varchar(255), users varchar(255), views_per_user varchar(255), avg_engagement_time varchar(255));")
